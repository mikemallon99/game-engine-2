...
public:
    ...
    void setVector2f(const std::string &name, float val0, float val1) const;
...
void Shader::setVector2f(const std::string &name, float val0, float val1) const
{         
...
{         
    glUniform3f(glGetUniformLocation(ID, name.c_str()), val0, val1, val2);
}
